 ...
 */
public class Siparis implements Cloneable {
    ...
    private List<Siparis> siparis = new ArrayList();

    public Siparis(String musteriAdi, String musteriNo, String sirketAdi, String sirketNo, List<Urun> urunler, double toplamFiyat) {
